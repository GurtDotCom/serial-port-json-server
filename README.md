...
This fork includes direct compatibility with Ethernet connected devices. Specifically CNC machines that have the WIZnet WIZ750SR Serial to Ethernet (S2E) modules.
